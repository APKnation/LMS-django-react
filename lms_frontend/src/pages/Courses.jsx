  ...
  const fetchCourses = async () => {
    try {
      ...
      if (selectedLevel !== "all")
        params.difficulty = selectedLevel.toLowerCase();
                    ...
                    <button className="px-4 py-2 text-sm bg-surface-card-dark border border-hairline-on-dark rounded-lg hover:bg-surface-elevated-dark transition-colors text-on-dark">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1.994 1.994 0 013 6.586V4z"
                        />
                      </svg>
                      Filter
                    </button>
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center text-sm text-muted mb-4">
                            <div className="flex items-center mr-4">
                              ...
                              <span
                                className="text-primary hover:text-primary-active cursor-pointer font-medium"
                                onClick={() =>
