          ...
          {loading ? (
            ...
            <div className="bg-surface-card-dark rounded-xl">
              <div className="px-6 py-4 border-b border-hairline-on-dark">
                <h2 className="text-title-md text-on-dark">Payout History</h2>
              </div>
                ...
                <table className="min-w-full divide-y divide-hairline-on-dark">
                  ...
                  <tbody className="bg-surface-card-dark divide-y divide-hairline-on-dark">
                    {payouts.length === 0 ? (
                      ...
                      payouts.map((payout) => (
                        <tr key={payout.id}>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-plex text-on-dark">
                            #{payout.id}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-dark font-plex">
                            TZS {payout.amount}
                          </td>
